...
import com.torres.springboot.backend.apirest.models.dao.IUsuarioDao;
...
public class UsuarioService implements UserDetailsService, IUsuarioService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			...
			throw new UsernameNotFoundException("Error en el login: no existe el usuario en '"+username+"' el sistema");
		}
